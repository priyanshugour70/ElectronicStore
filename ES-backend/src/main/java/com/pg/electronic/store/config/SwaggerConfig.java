...
public class SwaggerConfig {
    ...
    private ApiInfo getApiInfo() {
        ...
        ApiInfo apiInfo = new ApiInfo(
                ...
                "This is backend of Electronic Store",
                "1.0.0V",
                "https://www.linkedin.com/in/priyanshugour70/",
                new Contact("Priyanshu Gour", "https://www.instagram.com/priyanshugour70", "priyanshugour1@gmail.com"),
                "License of APIS",
                "https://www.priyanshugour70.vercel.app",
                new ArrayDeque<>()
        );
